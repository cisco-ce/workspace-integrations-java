...
public class UpdateWorkspace extends ValueObject {
    ...
    @JsonCreator
    public UpdateWorkspace(@JsonProperty("displayName") String displayName,
    ...
    public String toString() {
        return "{displayName=" + toPiiLengthString(displayName)
            + ", workspaceLocationId=" + workspaceLocationId
            + ", floorId=" + floorId
            + ", capacity=" + capacity
            + ", type=" + type
            + ", calling=" + calling
            + ", sipAddress=" + toPiiLengthString(sipAddress)
            + ", calendar=" + calendar
            + ", notes='" + toPiiLengthString(notes)
